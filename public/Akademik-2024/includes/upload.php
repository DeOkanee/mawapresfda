...
<head>
    ...
    <title>Upload Data Prestasi 2024</title>
...
if (!in_array($file_extension, ["jpg", "jpeg", "png", "gif", "pdf"])) {
    ...
    if ($uploadOk == 1) {
        if (move_uploaded_file($_FILES["sertifikat"]["tmp_name"], $target_file)) {
            $sql_mahasiswa = "INSERT INTO mahasiswa_2024 (nim, nama, prodi) VALUES (?, ?, ?)";
            ...
            if ($stmt_mahasiswa->execute()) {
                ...
                $sql_prestasi = "INSERT INTO prestasi_2024 (mahasiswa_id, jenis_prestasi, peringkat) VALUES (?, ?, ?)";
                ...
                if ($stmt_prestasi->execute()) {
                    ...
                    $sql_sertifikat = "INSERT INTO sertifikat_2024 (prestasi_id, file_path) VALUES (?, ?)";
                    ...
                    if ($stmt_sertifikat->execute()) {
                        ...
                        echo '<a href="../akademik-2024.html" class="btn btn-primary">Lihat Data</a>';
                        echo '</div>';
                    } else {
